...
class TuckerNesterov(Latent):
    def __init__(self, ranks):
        super(TuckerNesterov, self).__init__(ranks)
        self.core = 0
        self.factors = 0

    def __len__(self):
        return super(TuckerNesterov, self).__len__()
    ...
    def plotIter(self):
        super(TuckerNesterov, self).plotIter()

class GeneralizedCP(Latent):
    def __init__(self, ranks):
        super(GeneralizedCP, self).__init__(ranks)
        self.core = 0
        self.factors = 0

    def __len__(self):
        return super(GeneralizedCP, self).__len__()
    ...
    def plotIter(self):
        super(GeneralizedCP, self).plotIter()
